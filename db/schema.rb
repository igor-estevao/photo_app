...
ActiveRecord::Schema[7.0].define(version: 2023_06_05_140833) do
# Could not dump table "customer_plans" because of following StandardError
...
# Could not dump table "subscription_items" because of following StandardError
#   Unknown type 'uuid' for column 'id'
